...
export class Backend implements backendInterface {
    ...
    async getAllDares(): Promise<Array<Dare>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDares();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDareById(arg0: bigint): Promise<Dare> {
        if (this.processError) {
            try {
                const result = await this.actor.getDareById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDaresByCategory(arg0: string): Promise<Array<Dare>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDaresByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
